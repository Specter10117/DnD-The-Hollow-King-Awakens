...
###### Rolling a Nat 20
If a PC or a NPC rolls a Nat 20 for Initiative they have advantage on their first attack on the first round. They also are guaranteed to hit their first attack with a crit.


### Death
###### Adrenaline Surge
- Upon taking fatal damage (dropping to 0 HP, and not enough to instantly die), the player immediately gets a turn to take the attack action(can use action surge and other ability that grants multi attacking), but cannot heal during this time.
    - Only during this turn if the Player has Action Surge they regain all uses.
       - These do not count against their overall usage.
	- During this turn the player does not have disadvantage on any rolls.
	- Player can not heal at all during the turn.
	- Player drops dead at the end of this turn and will start their death saves as normal.
	- Other players can still revive this player after they have finished this turn.
	- Once per Long Rest.
	   - Usage Resets if Player Rolls a Nat 20 on Death Save.


# Critical_Hit
- When a Critical Hit Roll is Rolled (NAT 20), take the max damage of that can be rolled on the Crit and add the normal weapons damage (example: Greataxe does 1D12 damage, Crit would be 24 + 2d12)
